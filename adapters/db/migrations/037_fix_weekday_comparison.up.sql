-- Update the check_slot_availability function to properly handle weekday type conversion
...
DECLARE
    ...
    day_name weekday;
BEGIN
    -- Convert the day name to lowercase and cast to weekday enum
    day_name := LOWER(TO_CHAR(NEW.schedule_time AT TIME ZONE 'UTC', 'day'))::weekday;
