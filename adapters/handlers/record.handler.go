...
// @Success 201 {object} db.MedicalRecord "Medical record created successfully"
// @Failure 400 {object} utils.ErrorResponse "Invalid input data/file format"
...
// @Failure 413 {object} utils.ErrorResponse "File too large"
...
// @Success 200 {object} db.MedicalRecord "Medical record details"
...
// @Failure 401 {object} utils.ErrorResponse "Authentication required"
// @Failure 403 {object} utils.ErrorResponse "Not authorized to access this record"
// @Failure 404 {object} utils.ErrorResponse "Record not found"
// @Failure 500 {object} utils.ErrorResponse "Internal server error"
...
// @Param per_page query integer false "Records per page" minimum(1) maximum(100) default(10)
// @Success 200 {array} db.MedicalRecord "List of medical records"
// @Failure 400 {object} utils.ErrorResponse "Invalid diagnostic centre ID"
// @Failure 401 {object} utils.ErrorResponse "Authentication required"
// @Failure 403 {object} utils.ErrorResponse "Not authorized to access these records"
...
// @Success 200 {object} db.MedicalRecord "Record updated successfully"
// @Failure 400 {object} utils.ErrorResponse "Invalid input data"
// @Failure 401 {object} utils.ErrorResponse "Authentication required"
// @Failure 403 {object} utils.ErrorResponse "Not authorized to update this record"
// @Failure 404 {object} utils.ErrorResponse "Record not found"
// @Failure 500 {object} utils.ErrorResponse "Internal server error"
