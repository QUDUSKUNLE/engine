...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.LabPackageAnalysisRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Lab package analysis results",
                        "schema": {
                            "type": "object",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.MedicalImageAnalysisRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.SymptomAnalysisRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AnomalyDetectionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AutomatedReportRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.LabTest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Lab interpretation results",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ReportSummaryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/diagnostic_centres/owner": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter by admin assignment. true=with admin, false=without admin, omit=all centres",
                        "name": "admin",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.ListPaymentsDTO"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/domain.GetPaymentDTO"
                        }
                    },
                    "400": {
                        "description": "BAD_REQUEST",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.PaymentWebhookDTO"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Acknowledgement of webhook received",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/v1/payments/{payment_id}/refund": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Refund details (amount, reason, etc.)",
                        "name": "refund_request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.RefundPaymentDTO"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.ListPaymentsDTO": {
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/db.PaymentStatus"
                        }
                    ]
                },
                "toDate": {
        ...
        "handlers.AnomalyDetectionRequest": {
            "type": "object",
            "required": [
                "data",
                "data_type",
            ...
            "properties": {
                ...
                "patient_profile": {
                    "$ref": "#/definitions/services.PatientProfile"
                }
            }
        },
        ...
        "handlers.AutomatedReportRequest": {
            "type": "object",
            "required": [
                "report_data"
            ],
            "properties": {
                "report_data": {
                    "$ref": "#/definitions/services.ReportGenerationData"
                }
            }
        },
        ...
        "handlers.LabPackageAnalysisRequest": {
            ...
            "properties": {
                "package_data": {
                    "$ref": "#/definitions/services.LabPackageData"
                }
            }
        },
        ...
        "services.ReportGenerationData": {
            ...
            "properties": {
                ...
                "test_results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.TestResult"
                    }
                }
            }
        },
