...
type RecordRepository interface {
	...
	GetUploaderMedicalRecords(
		ctx context.Context,
		req db.GetUploaderMedicalRecordsParams,
	...
	UpdateMedicalRecord(
		ctx context.Context,
		req db.UpdateMedicalRecordByUploaderParams,
	) (*db.MedicalRecord, error)

	UpdateFilePath(
		ctx context.Context, req db.UpdateFilePathParams,
	) (*db.MedicalRecord, error)
}
