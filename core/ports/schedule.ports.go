...
type ScheduleRepository interface {
	...
	GetDiagnosticSchedule(
		ctx context.Context,
		req db.Get_Diagnostic_ScheduleParams,
	) (*db.DiagnosticSchedule, error)

	GetDiagnosticSchedules(
		ctx context.Context,
